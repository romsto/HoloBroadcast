...
public enum ParticleType {
    ...
    static {
        String ver = ReflectionUtil.version;
    ...
    /**
     * Get a particle type with its name
     *
     * @param particleName Name
     * @return ParticleType
     */
    public static Optional<ParticleType> getParticle(String particleName) {
        if (particles.containsKey(particleName.toLowerCase()))
            return Optional.of(particles.get(particleName.toLowerCase()));
        try {
            ParticleType particle = ParticleType.valueOf(particleName.toUpperCase());
            particles.put(particleName.toLowerCase(), particle);
    ...
    /**
     * @return true if this particle exists in the current server version
     */
    ...
    /**
     * @return DataType associated with the particle
     */
